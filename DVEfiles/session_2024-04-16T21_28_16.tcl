...
# DVE full session
# Saved on Tue Apr 16 21:28:16 2024
# Designs open: 1
...
#<Session mode="Full" path="/afs/ece.cmu.edu/usr/dzhang2/Private/18240/lab5/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 32} {1260 656}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 105} {height 392} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 134]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1220
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 134
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1252} {height 133} {dock_state bottom} {dock_on_new_line true}}
...
if { ![gui_is_db_opened -db {/afs/ece.cmu.edu/usr/dzhang2/Private/18240/lab5/simv}] } {
gui_sim_run Ucli -exe simv -args { -ucligui} -dir /afs/ece.cmu.edu/usr/dzhang2/Private/18240/lab5 -nosource
}
}
...
gui_sg_addsignal -group "$_session_group_2" { test_bench.DUT.start test_bench.DUT.reset test_bench.DUT.clock test_bench.DUT.a test_bench.DUT.b test_bench.DUT.out test_bench.DUT.done test_bench.DUT.ZN_flags test_bench.DUT.up test_bench.DUT.load test_bench.DUT.D test_bench.DUT.en_counter test_bench.DUT.clear_counter test_bench.DUT.count test_bench.DUT.sel test_bench.DUT.sel_a test_bench.DUT.AeqB test_bench.DUT.AgtB test_bench.DUT.b_abs test_bench.DUT.not_b test_bench.DUT.a_new test_bench.DUT.b_new test_bench.DUT.not_product test_bench.DUT.product test_bench.DUT.A_shifted test_bench.DUT.B_shifted test_bench.DUT.load_product test_bench.DUT.clear_product test_bench.DUT.product_in test_bench.DUT.select_add_amount test_bench.DUT.num_to_add test_bench.DUT.not_needed }
...
catch {gui_list_expand -id ${Hier.1} test_bench}
catch {gui_list_select -id ${Hier.1} {test_bench.DUT}}
